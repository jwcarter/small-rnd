...
/* rnd_95 - Pseudorandom number generator with period ~2^95
 *
 * Author: James Carter
 *
 * Full 64-bit output from a 32-bit Multiply-With-Carry (MWC) Lag 2
 ...
 * Using A=~2^32, B=2^32, L=3: Period = A*(2^32)^2/2-1 = ~2^95
 */
...
#define A  4293538899ULL /* MWC L2: 3 * 13 * 110090741 */
