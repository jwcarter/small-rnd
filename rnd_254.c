...
/* rnd_254 - Pseudorandom number generator with period ~2^190
 *
 * Author: James Carter
 *
 * Full 64-bit outputs from two 32-bit Multiply-With-Carry (MWC) Lag 3
...
#define A1 4293666429ULL /* MWC L3: 3 * 13 * 110094011 */
#define A2 4293542019ULL /* MWC L3: 3 * 13 * 110090821 */
